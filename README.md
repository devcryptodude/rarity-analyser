...
Cool Rarity was born in a [Hackathon](https://github.com/dirtypantiecape/01-rarity-analyser-hackathon) hosted by [DirtypantieScape](https://dirtypantiecape.xyz/), made with love by [Fukuball](https://twitter.com/fukuball). It is easy to configure for developers and easy to use for users, any ERC721 NFT collection with [OpenSea metadata stardard](https://docs.opensea.io/docs/metadata-standards) can use Cool Rarity as the rarity score calculation tool. If you have the collection metadata in hand, you can depoly Cool Rarity as your collection rarity tool in minues!

Here's the demo, One Day Dirtypantie rarity website: [https://onedaydirtypantie-rarity-tool.herokuapp.com/](https://onedaydirtypantie-rarity-tool.herokuapp.com/)
...
```
{
    ...
    collection_name: '10k One Day Dirtypanties',
    collection_description: '10k "One Day I\'ll Be A Dirtypantie"-dirtypantie – a homage to the one and only CryptoDirtypanties. Holding a OneDayDirtypantie will give you early access to DirtypantieScapes and reserve a profile on the DirtypantieScape website.',
    sqlite_file_name: 'database.sqlite',
    ga: 'G-BW69Z04YTP',
    main_og_image: 'https://onedaydirtypantie-rarity-tool.herokuapp.com/images/og.png'
}
```
...
- [X] Endpoint of JSON rarity data for every dirtypantie.
- [X] Test with other ERC721 collection metadata.
- [X] Matrix page.
- [X] Similarity analysis, create one page to show top 12 similar for every dirtypantie.

## Other Rarity Tools

### Our Friends (One Day Dirtypantie) - Also making cool tools!
...
<div>
  <a href="https://dirtypantiecape.xyz">
    <img src="https://dirtypantiecape.xyz/assets/logo.827c0d7f.png" alt="Powered by dirtypantiecape" width="240" height="40"/>
  </a>
</div>
<div>

<p>Thanks to DirtypantieScape Community for this initiative.</p>
</div>
